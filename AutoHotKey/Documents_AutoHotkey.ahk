...
:*?:sk````::
   ...
   ;timetil += 1, hour
	...
	SendInput /status :children_crossing: I have my kids for a bit.  I am here but I might step away unexpectedly (from %formattedtime% - ?)
return
:*?:lunch````::
...
:*?:oww````:: 
	...
	SendInput, Orchards Ward Weekly Email, %TimeString%
return
...
:*?c:email````::kimball.robinson@gmail.com
